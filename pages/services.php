<?php
$page_title = "Services";
$page_description = "Explore BitSync Group's comprehensive range of technology services including consumer electronics, enterprise solutions, web development, and consulting.";
?>
    ...
    <section class="relative py-32 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-8">
                ...
                <span class="text-white/90 text-sm font-medium">Premium Technology Solutions</span>
            </div>
            
            <h1 class="text-5xl md:text-7xl font-black text-white mb-8 leading-tight">
                Our <span class="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Services</span>
            </h1>
            <p class="text-xl md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
                Comprehensive technology solutions designed to transform your business 
                and drive innovation across all industries with cutting-edge expertise.
            </p>
        </div>
    </section>
    ...
    <section class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="p-6">
                ...
                <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="p-6">
                        <div class="w-full h-48 mb-6 rounded-lg overflow-hidden">
                            <img 
                                src="assets/mobile-development.jpg" 
                        ...
                        <p class="text-gray-600 mb-4">Native and cross-platform mobile applications that deliver exceptional user experiences across all devices.</p>
                        <ul class="text-sm text-gray-600 space-y-1 mb-4">
                ...
                <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold mb-3">Blockchain Technology</h3>
                        <p class="text-gray-600 mb-4">Decentralized solutions and cryptocurrency integration for secure, transparent, and efficient business operations.</p>
                        <ul class="text-sm text-gray-600 space-y-1 mb-4">
                ...
                <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold mb-3">Consulting Services</h3>
                        <p class="text-gray-600 mb-4">Strategic technology consulting and implementation guidance to help you make informed decisions and achieve your goals.</p>
                        <ul class="text-sm text-gray-600 space-y-1 mb-4">
    ...
    <section class="py-24 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl md:text-2xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed">
                Let's discuss how our premium services can transform your business and drive innovation across all industries.
            </p>
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a href="/contact" class="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-white font-semibold text-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <a href="/solutions" class="group px-8 py-4 border-2 border-white/30 rounded-xl text-white font-semibold text-lg backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-white/50">
                    View Solutions
