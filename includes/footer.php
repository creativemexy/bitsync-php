        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center mb-6">
                    ...
                    <h3 class="text-2xl font-black bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">BitSync Group</h3>
                </div>
                <p class="text-slate-300 mb-6 leading-relaxed">
                    Transforming businesses through cutting-edge technology solutions. We deliver innovation that drives growth and success.
                </p>
                <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 bg-slate-800 hover:bg-blue-600 rounded-xl flex items-center justify-center text-slate-300 hover:text-white transition-all duration-300 hover:scale-110">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex items-center space-x-6 text-sm">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-green-400 font-semibold">24/7 Support</span>
                    </div>
                </div>
            </div>
        </div>
