...
/**
 * User Reset Password
 * Allows regular users to reset their password using a token
 */
...
<head>
    ...
    <title>Reset Password - BitSync Workspace</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                <div class="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-workspace-100">
                    <i class="fas fa-key text-workspace-600 text-xl"></i>
                </div>
                    ...
                    <div>
                        <button type="submit" 
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <i class="fas fa-save text-workspace-500 group-hover:text-workspace-400"></i>
                            </span>
                            Reset Password
                        </button>
                    </div>
